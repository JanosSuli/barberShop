...
<div class=" flex flex-row h-screen bg-cover bg-center" style="background-image:url(img/background.png)">
    ...
    <div class="flex w-4/5 xl:w-10/12 mr-6 mt-6 mb-6 rounded-lg shadow-xl font-bold" style="background: #d7d3c8; color: #c13832;">
        <div class=" p-10" >
            <img class="rounded-full h-80 m-auto" src="img/blank-portrait.png" alt="placeholder" style="opacity: initial">
            <p class=" text-center m-5">Jack</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean scelerisque ipsum sem, eu feugiat lorem porta ac. Maecenas posuere turpis at fringilla tempus. Mauris ut purus id dolor aliquet faucibus. In aliquam mollis lectus, ac auctor lorem ultrices non. Praesent maximus, erat sit amet dictum blandit, nulla lacus varius erat, nec facilisis risus libero ut est. Phasellus dictum dui quis egestas cursus. Donec tincidunt sit amet lectus vel sodales.</p>
        </div>
        <div class=" p-10 opacity-100">
            <img class="rounded-full h-80 m-auto" src="img/blank-portrait.png" alt="placeholder" style="opacity: initial">
            <p class=" text-center m-5">Barbara</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean scelerisque ipsum sem, eu feugiat lorem porta ac. Maecenas posuere turpis at fringilla tempus. Mauris ut purus id dolor aliquet faucibus. In aliquam mollis lectus, ac auctor lorem ultrices non. Praesent maximus, erat sit amet dictum blandit, nulla lacus varius erat, nec facilisis risus libero ut est. Phasellus dictum dui quis egestas cursus. Donec tincidunt sit amet lectus vel sodales.</p>
        </div>
    </div>
</div>
